...
// ParsePprof 解析性能分析配置。
func ParsePprof(cfg *configv1.Bootstrap) *configv1.Pprof {
	if cfg == nil {
		return nil
	}
	return cfg.GetPprof()
...
func ParseAppInfo(ctx *bootstrap.Context) *configv1.AppInfo {
	if ctx == nil || ctx.GetAppInfo() == nil {
		return &configv1.AppInfo{}
	}
	return ctx.GetAppInfo()
}

// ParseOSS 解析对象存储配置。
func ParseOSS(cfg *configv1.Bootstrap) *configv1.Oss {
	if cfg == nil {
		return nil
	}
	return cfg.GetOss()
...
// ParseQueue 解析队列配置。
func ParseQueue(cfg *configv1.Bootstrap) *configv1.Data_Queue {
	if cfg == nil || cfg.GetData() == nil {
		return nil
	}
	return cfg.GetData().GetQueue()
}

// ParseRedis 解析 Redis 配置。
func ParseRedis(cfg *configv1.Bootstrap) *configv1.Data_Redis {
	if cfg == nil || cfg.GetData() == nil {
		return nil
	}
	return cfg.GetData().GetRedis()
}
...
func ParseTranslator(cfg *configv1.Bootstrap) *configv1.Translator {
	if cfg == nil {
		return nil
	}
