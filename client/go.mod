...
require (
	...
	github.com/liujitcn/kratos-kit/tracing v0.0.9 // indirect
	...
	github.com/liujitcn/kratos-kit/transport/mcp v0.0.12 // indirect
	github.com/liujitcn/kratos-kit/transport/sse v0.0.10 // indirect
